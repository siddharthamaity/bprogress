...
<Tabs groupId="packageManager" items={['npm', 'pnpm', "yarn", "bun"]} persist>
  ...
  <Tab value="yarn">
    ```bash
    yarn add @bprogress/vue
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @bprogress/vue
    ```
  </Tab>
</Tabs>
...
<Cards>
  <Card external title="NPM" href="https://www.npmjs.com/package/@bprogress/vue" icon={<SiNpm />}>
    Check the package on NPM
  </Card>
  <Card external title="GitHub" href="https://github.com/Skyleen77/bprogress/tree/main/packages/vue" icon={<FaGithub />}>
