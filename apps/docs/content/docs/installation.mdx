...
<Tabs groupId="packageManager" items={['npm', 'pnpm', 'yarn', 'bun']} persist>
  <Tab value="npm">```bash npm install @bprogress/core ```</Tab>
  <Tab value="pnpm">```bash pnpm add @bprogress/core ```</Tab>
  <Tab value="yarn">```bash yarn add @bprogress/core ```</Tab>
  <Tab value="bun">```bash bun add @bprogress/core ```</Tab>
</Tabs>
...
<Cards>
  ...
  <Card
    external
    title="GitHub"
    href="https://github.com/imskyleen/bprogress/tree/main/packages/core"
    icon={<FaGithub />}
  >
